...
% TROP TOT, CA FAIT REDITES avec decomposition criterion When such overlaps are needed, they should be chosen in order to ease the verification decomposition. In this precision spraying problem, considering the decomposition that can be required to calculate the optimal sequence for spraying a row, supposedly at a constant speed, the overlap zone is a block as described in section \ref{sec:step2}. 
...
%\begin{figure}[h!]
%\begin{center}
%\includegraphics[width=7.8cm]{JournalDecPulvMod.pdf} 
